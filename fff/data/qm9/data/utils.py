...
from fff.data.qm9.data.dataset_class import ProcessedDataset
from fff.data.qm9.data.prepare.download import prepare_dataset


def initialize_datasets(datadir, dataset, subset=None, splits=None,
                        force_download=False, subtract_thermo=False,
                        remove_h=False, include_charges=True):
    """
    Initialize datasets.
    ...
    datasets = {
        split: ProcessedDataset(data, included_species=all_species,
